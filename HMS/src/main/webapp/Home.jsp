    ...
    <div class="main-container">
        ...
        <div class="button-container">
            ...
            <div class="sub-buttons">
                ...
                <button onclick="window.location.href='viewServAppo.jsp'">View Hospital Service Appointment</button>
            ...
            <button onclick="window.location.href='inpBill.jsp'">Payments</button>
            <button onclick="window.location.href='inpBillView.jsp'">Payment Receipt</button>
        </div>
    </div>
