    ...
    <div class="appointment-details">
        ...
        <form method="post">
            ...
            <select id="patientId" name="patientId" required>
                ...
                <%
                    try (Connection conn = DriverManager.getConnection(url, user, password)) {
                        String sql = "SELECT patient_id FROM OutPatients ORDER BY patient_id";
                        ...
                        out.println("<option value=''>Error loading patient IDs</option>");
                    }
                %>
            </select>

            <label for="doctorId">Doctor ID(D00X):</label>
            <input type="text" id="doctorId" name="doctorId" pattern="D00[0-9]" title="Please enter Doctor ID in D00X format (e.g., D001)" required>
